...
const Home = () => {
  return (
    ...
    {/* md:p-16 sm:p-8 p-2    */}
        ...
        <div className="flex flex-col justify-center items-center content-center  p-4 gap-8">

            {/* NAV BAR */}
            <div className="  w-screen text-white flex flex-row justify-center ">

                {/* MINI NAV BAR */}
                <nav className="flex flex-row md:max-w-[1024px]  xl:min-w-[80%]   rounded-3xl  gap-8 h-[45px] ">
            ...
            <div className=" flex justify-center  md:flex-row flex-col sm:gap-8 gap-2  md:max-w-[1024px]  xl:min-w-[80%]  h-full  "> 
