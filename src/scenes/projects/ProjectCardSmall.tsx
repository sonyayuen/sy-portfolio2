...
const ProjectCardSmall = ({ name, description, image,color,link,textcolor}: Props) => {
  
  return (

    <Link to={link} className="shrink-0  w-full h-full snap-start snap-always " >

      <div className={ `${color} ${textcolor}  rounded-3xl flex md:flex-nowrap flex-wrap items-center justify-items-center justify-around  p-4  shrink  h-full w-full  `}> 

        
          {/* Left part with text */}
          <div className="  w-full h-full  flex flex-col  justify-center gap-y-2  p-4  ">
